...
describe('random', () => {
  test.each([
    ...
    { length: '1', message: 'string must be greater than 1', spec: 'length is less than 2' },
    { length: '101', message: 'string must be less than 100 characters', spec: 'length is greater than 100' },
